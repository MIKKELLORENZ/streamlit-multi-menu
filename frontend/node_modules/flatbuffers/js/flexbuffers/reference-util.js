...
function valueForIndexWithKey(index, key, dataView, offset, parentWidth, byteWidth, length, path) {
    ...
    return new reference_1.Reference(dataView, elementOffset, (0, bit_width_util_1.fromByteWidth)(byteWidth), packedType, path + "/" + key);
}
...
function keyForIndex(index, dataView, offset, parentWidth, byteWidth) {
    ...
    return (0, flexbuffers_util_1.fromUTF8Array)(new Uint8Array(dataView.buffer, keyIndirectOffset, length));
}
